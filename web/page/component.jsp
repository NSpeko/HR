    ...
    <section class="content">
        <div class="notificationsSlides">
            ...
            <p>Success in a job interview starts with a solid foundation of knowledge on the jobseeker’s part. You
                ...
                people) interviewing you. The more research you conduct, the more you’ll understand the employer, and
                the better you’ll be able to answer interview questions (as well as ask insightful questions see #8).
                Scour the organization’s website and other published materials, search engines, research tools, and ask
                questions about the <a href="https://company.livecareer.com">company in your network</a> of contacts.
            </p>
        </div>
        <div class="notificationsSlides">
            ...
            <p>Another key to <a href="https://www.myperfectresume.com/how-to/career-resources/interview/">interview
                ...
                interview questions</a>. First, ask the hiring manager as to the type of interview to expect. Will it be
                one-on-one or in a group? Will it be with one person, or will you meet several members of the
                organization? Your goal is to try to determine what you’ll be asked and to compose detailed yet concise
            ...
            <p>A good tool for remembering your responses is to put them into a story form that you can tell in the
                ...
                There are excellent <a href="https://www.livecareer.com/">tools</a> available to help you with interview
                questions and responses. Also, consider using the <a
                        href="https://www.livecareer.com/career/advice/interview/star-interviewing">STAR Interviewing
                    Technique</a>.</p>
        </div>
        <div class="notificationsSlides">
            ...
            <p>Plan out a wardrobe that fits the organization and its culture, striving for the most professional
                ...
                wear clothing that fits and is clean and pressed. Keep accessories and jewelry to a minimum. Try not to
        ...
        <div class="notificationsSlides">
            ...
            <p>There is no excuse ever for arriving late to an interview. Short of a disaster, strive to arrive about 15
                minutes before your scheduled interview to complete additional paperwork and allow yourself time to get
                settled. Arriving a bit early is also a chance to observe the dynamics of the workplace.</p>
            <p>The day before the interview, pack up extra copies of your resume or CV and reference list. If you have a
                portfolio or samples of your work, bring those along too. Finally, remember to pack several pens and a
        ...
        <div class="notificationsSlides">
            ...
            <p>A cardinal rule of interviewing is to be polite and offer warm greetings to everyone you meet from the
                ...
                impression interviewers get in the first few seconds of meeting you can make or break an interview.</p>
            <blockquote class="tip-quote"><p>Make a strong first impression by dressing well (see #3), arriving early
                (see #4), and when greeting your interviewer, stand, smile, make eye contact, and offer a firm&#147; but
                not bone-crushing&#147; handshake.</p></blockquote>
            <p>Remember that having a positive attitude and expressing enthusiasm for the job and employer are vital in
                the initial stages of the interview; studies show that hiring managers make critical decisions about job
                applicants in the first 20 minutes of the interview.</p>
        </div>
        <div class="notificationsSlides">
            <h3>6. Be Authentic, Upbeat, Focused, Confident, Candid, and Concise</h3>
            <p>Once the interview starts, the key to success is the quality and delivery of your responses. Your goal
                should always be authenticity, responding truthfully to interview questions. At the same time, your goal
            ...
            <p>By preparing responses to common interview questions (see #2), you’ll ideally avoid long, rambling
                ...
                point. Finally, no matter how much an interviewer might bait you, never badmouth a previous employer,
                boss, or co-worker. The interview is about you and making your case that you are the ideal candidate
                for the job.</p>
        </div>
        <div class="notificationsSlides">
            <h3>7. Remember the Importance of Body Language</h3>
            <p>While the content of your interview responses is paramount, poor body language can be a distraction at
        ...
        <div class="notificationsSlides">
            ...
            <p>Studies continually show that employers make a judgment about an applicant’s interest in the job by
                whether or not the interviewee asks questions. Thus, even if the hiring manager was thorough in his or
                her discussions about the job opening and what is expected, you must ask a few questions. This shows
                that you have done your research and that you are curious. The smart jobseeker prepares questions to ask
        ...
        <div class="notificationsSlides">
            ...
            <p>The most qualified applicant is not always the one who is hired; the winning candidate is often the
                jobseeker who does the best job responding to interview questions and showcasing his or her fit with the
            ...
            <p>Finally, as the interview winds down, ask about the next steps in the process and the timetable in which
        ...
        <div class="notificationsSlides">
            ...
            <p>Common courtesy and politeness go far in interviewing; thus, the importance of thanking each person who
                ...
                interview will not get you the job offer, but doing so will certainly give you an edge over any of the
